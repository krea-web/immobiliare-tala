...
const DiscoveryCTA: React.FC<DiscoveryCTAProps> = ({ onOpenAbout }) => {
  return (
    <section className="relative py-40 md:py-60 bg-[var(--bg-primary)] overflow-hidden group transition-colors duration-500">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-radial-gradient(circle at center, transparent 0%, var(--bg-primary) 100%) opacity-80"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col items-center text-center pt-20">
          ...
          {/* Main Title */}
          <h2 className="text-6xl md:text-8xl lg:text-[9.5rem] font-serif text-[var(--text-primary)] mb-10 leading-[0.8] tracking-tighter max-w-5xl">
          ...
          <p className="text-[var(--text-secondary)] text-lg md:text-2xl font-light max-w-2xl mb-20 leading-relaxed tracking-wide opacity-90">
          ...
          <div className="relative group/btn mb-32">
            ...
            <button 
                onClick={onOpenAbout}
                className="btn-super-glow btn-ray-effect relative bg-[var(--bg-reverse)] text-[var(--text-reverse)] px-16 py-7 rounded-full text-[12px] font-bold uppercase tracking-[0.4em] shadow-[0_30px_60px_rgba(0,0,0,0.6)] flex items-center gap-6 overflow-hidden transition-all hover:translate-y-[-5px] active:scale-95"
            >
                <div className="btn-inner-bg bg-[var(--bg-reverse)]"></div>
                <span className="relative z-10 flex items-center gap-2">Inizia il Viaggio</span>
                <div className="relative z-10 flex items-center justify-center w-8 h-8 rounded-full bg-[var(--bg-primary)] text-[var(--text-primary)] group-hover/btn:scale-125 group-hover/btn:bg-[#A18058] transition-all duration-500">
          ...
          <div className="w-full max-w-4xl pt-16 border-t border-[var(--border-primary)] flex flex-col items-center">
              ...
              <div className="mb-16 flex flex-col items-center gap-2 opacity-60 hover:opacity-100 transition-opacity duration-700">
                  <p className="text-[9px] font-bold uppercase tracking-[0.5em] text-[var(--text-tertiary)] mb-2">Curato personalmente da</p>
                  <div className="relative">
                      <span className="font-serif italic text-3xl text-[var(--text-primary)] select-none">Andrea Tala</span>
                      {/* Stylized Underline */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0 w-full items-center">
                  ...
                  <div className="flex flex-col items-center gap-4 group/badge">
                      <div className="w-14 h-14 rounded-2xl bg-[var(--bg-secondary)] border border-[var(--border-primary)] flex items-center justify-center text-[#A18058] group-hover/badge:bg-[#A18058] group-hover/badge:text-white transition-all duration-500 shadow-xl backdrop-blur-md">
                          <Diamond size={24} strokeWidth={1.5} />
                      </div>
                      <div className="text-center">
                          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-[var(--text-primary)] mb-1">Rare Assets</p>
                          <p className="text-[8px] text-[var(--text-tertiary)] uppercase tracking-widest">Collezione Off-Market</p>
                      </div>
                  </div>

                  {/* Divider md:only */}
                  <div className="hidden md:block w-px h-12 bg-gradient-to-b from-transparent via-[var(--border-primary)] to-transparent"></div>
                  ...
                  <div className="flex flex-col items-center gap-4 group/badge">
                      ...
                      <div className="text-center">
                          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-[var(--text-primary)] mb-1">Total Privacy</p>
                          <p className="text-[8px] text-[var(--text-tertiary)] uppercase tracking-widest">Trattative Protette</p>
                      </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-4 group/badge">
                      ...
                      <div className="text-center">
                          <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-[var(--text-primary)] mb-1">Elite Network</p>
                          <p className="text-[8px] text-[var(--text-tertiary)] uppercase tracking-widest">Presenza Globale</p>
                      </div>
                  </div>
